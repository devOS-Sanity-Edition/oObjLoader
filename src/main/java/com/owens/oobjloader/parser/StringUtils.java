...
public class StringUtils {
	...
	public static int[] parseListVerticeNTuples(BiConsumer<Level, String> logger, String list, int expectedValuesPerTuple) {
		...
		ArrayList<Integer> returnList = new ArrayList<>();
		int emptyMarker = ObjBuilder.EMPTY_VERTEX_VALUE;
	...
	private static void parseVerticeNTuple(String list, ArrayList<Integer> returnList, int emptyMarker, int expectedValueCount) {
