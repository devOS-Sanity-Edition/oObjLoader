...
//        log.log(INFO,"Parsed face=" + face);
	...
	// @TODO: I think I need to just delete this... because we now parse material lib files in ObjParser.java in processMaterialLib()
...
//    }
	...
	public void doneParsingMaterial() {
		...
		// better than quiet bugs.)   This method ( doneParsingMaterial() ) is called by ObjParser when
		// it finished parsing a .mtl file.
		//
		// @TODO: We can make this not throw an exception if we simply add a check for a null
		// currentMaterialBeingParsed at the start of each material setter method in ObjBuilderImpl... but that
	...
	public String toString() {
		return "ObjBuilderImpl{" +
				"objFilename='" + objFilename + '\'' +
				", verticesG=" + verticesG +
				", verticesT=" + verticesT +
				", verticesN=" + verticesN +
				", faceVerticeList=" + faceVerticeList +
				", faces=" + faces +
				...
				", faceQuadCount=" + faceQuadCount +
				", facePolyCount=" + facePolyCount +
				", faceErrorCount=" + faceErrorCount +
				", faceVerticeMap=" + faceVerticeMap +
				", currentSmoothingGroupNumber=" + currentSmoothingGroupNumber +
				", currentSmoothingGroup=" + currentSmoothingGroup +
				", currentGroups=" + currentGroups +
				", currentGroupFaceLists=" + currentGroupFaceLists +
				", currentMaterial=" + currentMaterial +
				", currentMap=" + currentMap +
				", currentMaterialBeingParsed=" + currentMaterialBeingParsed +
				", currentMapBeingParsed=" + currentMapBeingParsed +
				'}';
	}
}
